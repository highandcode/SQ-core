...
class BaseBuild {
  ...
  processDefault() {
    ...
    console.log(chalk.cyan(`${this.config.target}: removing local configuration`));
    data = this.removeContent(data, this.localVars.start, this.localVars.end);
    console.log(chalk.cyan(`${this.config.target}: removing tags configuration`));
    data = this.removeContent(data, this.localTags.start, this.localTags.end);
    console.log(chalk.cyan(`${this.config.target}: removing html configuration`));
    ...
    let afterAddingHtml = this.insertContent(afterAddingScript, this.tags.findBody, this.tags.htmlToInclude);
