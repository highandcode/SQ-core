...
function ImageCard(
  ...
  const styles = imageUrl && !disabledImage ? { backgroundImage: `url(${ imageUrl })` } : {};
  return (
    <div
      ...
      <div className="sq-image-card__container">
        <div style={ styles } className="sq-image-card__img-container">
          { !imageUrl && !disabledIcon && <Icon
            className="sq-image-card__no-image" size="large" name={ iconName || 'HideImage' }
            color={ iconColor }/> }
          <div className="sq-image-card__overlay"></div>
          <Actions className="sq-image-card__actions sq-actions--vertical" actions={ actions } onAction={ onAction }/>
        </div>
        <div className="sq-image-card__content-container">
          <div className="sq-image-card__text-wrapper">
            <div className="sq-image-card__outer-text">
              { iconName &&
              <Icon className="sq-image-card__text-icon" size="large" name={ iconName } color={ iconColor }/> }
            ...
            <div className="sq-image-card__extra">
              { tagLabel && <TagLabel
                className="sq-image-card__tag" size={ tagSize } color={ tagColor }
                value={ tagLabel }></TagLabel> }
            </div>
          </div>
          <MoreActions className="sq-image-card__more-actions" actions={ actions } onAction={ onAction }/>
        </div>
      </div>
    </div>
  );
